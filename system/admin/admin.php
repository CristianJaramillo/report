...
?>
	<div id="nav-container">
					...
					<ul class="right" id="pc-menu">
						...
						<li class="left"><a class="item-nav" href="<?php if(defined('DOIMAN')){echo DOIMAN;if(isset($_SESSION['URL'])){echo $_SESSION['URL'];}}?>chars.php">Graficas</a></li>
						<li class="left"><a class="item-nav" href="<?php if(defined('DOIMAN')){echo DOIMAN;if(isset($_SESSION['URL'])){echo $_SESSION['URL'];}}?>report.php">Reportes</a></li>
						<li class="left"><a class="item-nav" href="<?php if(defined('DOIMAN')){echo DOIMAN;if(isset($_SESSION['URL'])){echo $_SESSION['URL'];}}?>system.php">Sistema</a></li>
						<li class="left"><a class="item-nav" href="<?php if(defined('DOIMAN')){echo DOIMAN;if(isset($_SESSION['URL'])){echo $_SESSION['URL'];}}?>users.php">Usuarios</a></li>
				...
				<div class="panel">
					<div id="nav-movile">
						<ul>
							...
							<li class="item-movile" ><a href="<?php if(defined('DOIMAN')){echo DOIMAN;if(isset($_SESSION['URL'])){echo $_SESSION['URL'];}}?>chars.php">Graficas</a></li>
							<li class="item-movile" ><a href="<?php if(defined('DOIMAN')){echo DOIMAN;if(isset($_SESSION['URL'])){echo $_SESSION['URL'];}}?>report.php">Reportes</a></li>
							<li class="item-movile" ><a href="<?php if(defined('DOIMAN')){echo DOIMAN;if(isset($_SESSION['URL'])){echo $_SESSION['URL'];}}?>system.php">Sistema</a></li>
							<li class="item-movile" ><a href="<?php if(defined('DOIMAN')){echo DOIMAN;if(isset($_SESSION['URL'])){echo $_SESSION['URL'];}}?>users.php">Usuarios</a></li>
